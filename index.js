...
console.log("3'ün tam kati olan sayilar:", ucetambolunenler);
...
console.log("3'ün tam kati olan sayilarin toplami:" + ucebolunenlerintoplami);
...
console.log("500'den kücük sayilar:" + besyuzdenkucuksayilar);
...
console.log("Küçükten büyüğe siralanmis sayilar:" + siralisayilar);
...
for (const sayi in tekrarSayilari) {
  if (tekrarSayilari.hasOwnProperty(sayi) && tekrarSayilari[sayi] > 1) {
    const tekrarSayisi = tekrarSayilari[sayi];
    tekraredensayilar.push(
      `${sayi} sayisi ${tekrarSayisi} kere tekrar edilmiştir`
    );
  }
}
